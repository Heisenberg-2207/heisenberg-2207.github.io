...
class SearchEngine:
	...
	def __init__(self, args):
		...
		self.informationRetriever = InformationRetrieval(mode=self.args.retrieval_mode, use_wsd=False)
		self.evaluator = Evaluation()

	def expand_query(self, query, max_synonyms=2):
		"""
	...
	def evaluateDataset(self):
		...
		expandedQueries = []
		for query in queries:
			expanded_query = self.expand_query(query)  # Use query expansion here
			expandedQueries.append(expanded_query)
...
if __name__ == "__main__":
	...
	parser.add_argument('-retrieval_mode', default="tfidf",
					    help = "Retrieve type [tfidf|lsa|autoencoder|word2vec]")
	...
	timestop = time.time()
	print("Time taken : " + str(timestop - timestart) + " seconds")